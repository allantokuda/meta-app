MetaApp::Application.routes.draw do
  ...
  namespace :v1 do
    ...
    get    'entities/:id/attributes' => "attributes#index"
    post   'entities/:id/attributes' => "attributes#create"
    ...
    get    'attributes/:id' => "attributes#show"
    put    'attributes/:id' => "attributes#update"
